			...
			<div class="col-xl-12 col-md-12 col-sm-12 col-12">
				<header>
					...
					<h3 style="text-align: right; margin-right: 10px;">
						Welcome ${userData.getUserName()} ! &nbsp
						<a href= "Logout"><i class="fa fa-close"
				...
				<fieldset>
					...
					<a href="AddEmployee"> <input type="button"
						value="Upload Employee Details " class="btn2"></a>
						<a href="download"> <input
						type="button" value="Download Employee Details " class="btn3"></a>
					<table class="t1">
						<tr>
							<th>Employee Code</th>
							<th>Employee Name</th>
